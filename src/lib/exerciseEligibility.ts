...
const REQUIREMENT_RULES: Record<string, EquipmentRequirementGroup[]> = {
  ...
  dip: [["dip_station"]],
  weighted_dip: [["dip_station"]],
  dumbbell_fly: [["adjustable_dumbbells", "adjustable_bench"]],
  incline_dumbbell_fly: [["adjustable_dumbbells", "adjustable_bench"]],
  jm_press: [["barbell", "adjustable_bench", "power_rack"], ["adjustable_dumbbells", "adjustable_bench"]],
  ...
  spider_curl: [["adjustable_dumbbells", "adjustable_bench"], ["barbell", "adjustable_bench"]],
  reverse_curl: [["barbell"], ["adjustable_dumbbells"], ["resistance_bands"]],
  ...
  reverse_lunge: [["adjustable_dumbbells"], ["barbell", "power_rack"], ["bodyweight_space"]],
  walking_lunge: [["adjustable_dumbbells"], ["barbell", "power_rack"], ["bodyweight_space"]],
  pin_squat: [["barbell", "power_rack"]],
